...
export class ScanPage {
  ...
  private sendPaymentToAddress(monoeciAddress: string, coin: string): void {
    this.navCtrl.push(AmountPage, { toAddress: monoeciAddress, coin });
  }

  private addToAddressBook(monoeciAddress: string): void {
    this.navCtrl.push(AddressbookAddPage, { addressbookEntry: monoeciAddress });
  }
